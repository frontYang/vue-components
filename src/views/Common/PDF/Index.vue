<template>
  <div class="page">
    <el-button type="primary" @click="printPdf">生成图片</el-button>
    <el-button type="primary" @click="savePdf">导出方式一(pdf)</el-button>
    <el-button type="primary" @click="getPdf('#exportPdf')">导出方式二(pdf)</el-button>
    <el-button type="primary" @click="getPdf3('#exportPdf')">导出方式三(pdf)</el-button>
    <!-- <el-button type="primary" @click="print">window.print(pdf)</el-button> -->
...
<script>
import { downloadPDF, previewImg } from './pdf'
import outputPdf from './pdf2'
...
export default {
  ...
  methods: {
    savePdf() {
      downloadPDF(this.$refs.exportPdf, '我的文件')
    },
    async printPdf() {
      const image = await previewImg(document.getElementById('exportPdf'), '我的文件', 'portrait')
      this.image = image
    },
    getPdf3() {
      outputPdf({
        element: document.querySelector('#exportPdf'),
